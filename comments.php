    ...
    if ( have_comments() ) : ?>
        ...
        <?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // Are there comments to navigate through? ?>
            <nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
                <h2 class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'vincent-sureau-portfolio' ); ?></h2>
                <div class="nav-links">

                    <div class="nav-previous"><?php previous_comments_link( esc_html__( 'Older Comments', 'vincent-sureau-portfolio' ) ); ?></div>
                    <div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments', 'vincent-sureau-portfolio' ) ); ?></div>
        ...
        <ul class="comment-list">
            <?php
            wp_list_comments( array( 'callback' => 'Vincent_Sureau_Portfolio_comment', 'avatar_size' => 50 ));
            ?>
        </ul><!-- .comment-list -->
    ...
    <div class="bg-duck-blue p-4">
        <?php comment_form( $args = array(
            ...
            'comment_notes_after' => '<p class="form-allowed-tags">' .
                __( 'Vous pouvez utiliser ces <abbr title="HyperText Markup Language">HTML</abbr> balises et attributs:', 'vincent-sureau-portfolio' ) .
